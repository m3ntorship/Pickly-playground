...
export const InputWithOption_OPTION = {
  TYPE: {
    A: "A",
    B: "B",
    C: "C",
...
export const InputWithOption = ({ type }) => {
  return (
    <>
      {type === InputWithOption_OPTION.TYPE.A && (
        <div className="h-10 w-18xl flex flex-row items-center border rounded-bl-md rounded-br-md  border-grey-shd5">
          <svg
      ...
      {type === InputWithOption_OPTION.TYPE.B && (
        <div className="h-10 w-18xl flex flex-row items-center border rounded-bl-md rounded-br-md  border-grey-shd5">
          <svg
            className="my-3 mr-3 ml-1.5"
            width="24"
      ...
      {type === InputWithOption_OPTION.TYPE.C && (
        <div className="h-10 w-18xl flex flex-row items-center border rounded-bl-md rounded-br-md  border-grey-shd5">
          <svg
            className="my-3 mr-3 ml-1.5"
            width="24"
      ...
      {type === InputWithOption_OPTION.TYPE.D && (
        <div className="h-10 w-18xl flex flex-row items-center border rounded-bl-md rounded-br-md  border-grey-shd5">
          <svg
            className="my-3 mr-3 ml-1.5"
            width="24"
